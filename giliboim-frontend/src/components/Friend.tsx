    ...
    return (
        <div>
            ...
            {isDeletePopupOpen && (
                <div className="popup delete-popup">
                    <div className="popup-content delete-popup-content">
                        <p>정말 {selectedFriend}을(를) 삭제하시겠습니까?</p>
            ...
            {isAddFriendPopupOpen && (
                <div className="popup add-friend-popup">
                    <div className="popup-content add-friend-popup-content">
                        ...
                        <input
                            ...
                            className="popup-input add-friend-input"
                        />
                        ...
                        <button className="confirm-button add-friend-confirm-button" onClick={handleAddFriendConfirm}>친구 추가</button>
                        <button className="cancel-button add-friend-cancel-button" onClick={handleAddFriendCancel}>취소</button>
                    </div>
                </div>
            )}
        </div>
