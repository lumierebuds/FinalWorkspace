...
import '../../styles/admin/AdminPost.css';
...
const AdminPost: React.FC = () => {
  const [posts, setPosts] = useState([
    { id: 1, type: '신고', name: '회원1', content: '이것은 신고된 게시물입니다.' },
    { id: 2, type: '신고', name: '회원2', content: '신고된 게시물 내용입니다.' },
    { id: 3, type: '신고', name: '회원3', content: '또 다른 신고된 게시물입니다.' },
    { id: 4, type: '일반', name: '회원4', content: '일반 게시물 내용입니다.' },
    { id: 5, type: '일반', name: '회원5', content: '또 다른 일반 게시물입니다.' },
    { id: 6, type: '신고', name: '회원6', content: '신고된 게시물입니다.' },
    { id: 7, type: '일반', name: '회원7', content: '일반 게시물입니다.' },
    { id: 8, type: '신고', name: '회원8', content: '신고된 게시물입니다.' },
  ]);
